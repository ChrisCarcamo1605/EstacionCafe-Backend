...
export class SupplierSeeder extends BaseSeeder {
  ...
  async revert(): Promise<void> {
    ...
    const supplierNames = [
      "Café Gourmet Internacional", "Distribuidora Valle Verde", "Lácteos San Martín",
      "Chocolate Premium Corp", "Tés del Mundo Ltda", "Azucarera Nacional",
      "Empaques y Descartables", "Especias Aromáticas", "Siropes y Sabores",
      "Suministros Barista Pro", "Productos de Limpieza Hosteleros", "Snacks y Complementos"
    ];

    await supplierRepo.delete({ name: supplierNames as any });
