...
export class IngredientSeeder extends BaseSeeder {
  ...
  async run(): Promise<void> {
    ...
    const ingredients = [
      ...
      { consumableId: 6, name: "Leche Entera", quantity: 42.0, productId: 9 }, // 180ml leche
      {
        consumableId: 23,
      ...
      { consumableId: 6, name: "Leche Entera", quantity: 30.0, productId: 11 }, // 180ml leche
      ...
      { consumableId: 6, name: "Leche Entera", quantity: 10.0, productId: 13 }, // 150ml leche
      {
        consumableId: 10,
        name: "Chocolate Premium",
        quantity: 30.0,
      ...
      { consumableId: 6, name: "Leche Entera", quantity: 10.0, productId: 14 }, // 180ml leche
      ...
      { consumableId: 6, name: "Leche Entera", quantity: 20.0, productId: 15 }, // 180ml leche
      {
        consumableId: 21,
      ...
      { consumableId: 6, name: "Leche Entera", quantity: 20.0, productId: 16 }, // 200ml leche
    ];
    ...
    for (const ingredient of ingredients) {
      ...
      if (!exists) {
        ...
        console.log(
          `---SUCESS--- Ingredient created: ${ingredient.name} (${ingredient.quantity}g/ml) for Product ID ${ingredient.productId}`,
        );
      } else {
        console.log(
          `---WARNING--- Ingredient already exists: ${ingredient.name} for Product ID ${ingredient.productId}`,
        );
      }
    }
  }
  ...
  async revert(): Promise<void> {
    ...
    await ingredientRepo.delete({ productId: In(productIds) });
